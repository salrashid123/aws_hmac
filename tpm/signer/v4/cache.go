...
func (s *derivedKeyCache) Get(credentials hmaccred.TPMSigner, service, region string, signingTime SigningTime) ([]byte, error) {
...
func (s *derivedKeyCache) get(key string, credentials hmaccred.TPMSigner, signingTime time.Time) ([]byte, bool) {
...
func (k *SigningKeyDeriver) DeriveKey(credential hmaccred.TPMSigner, service, region string, signingTime SigningTime) ([]byte, error) {
	return k.cache.Get(credential, service, region, signingTime)
}

func deriveKey(cred hmaccred.TPMSigner, service, region string, t SigningTime) ([]byte, error) {
