...
func (s *derivedKeyCache) Get(credentials hmaccred.TPMSigner, service, region string, signingTime SigningTime) []byte {
...
func (k *SigningKeyDeriver) DeriveKey(credential hmaccred.TPMSigner, service, region string, signingTime SigningTime) []byte {
	return k.cache.Get(credential, service, region, signingTime)
}

func deriveKey(cred hmaccred.TPMSigner, service, region string, t SigningTime) []byte {
