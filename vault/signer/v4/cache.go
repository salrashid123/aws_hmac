...
import (
	...
	hmaccred "github.com/salrashid123/aws_hmac/vault/signer"
)
...
func (s *derivedKeyCache) Get(credentials hmaccred.VaultSigner, service, region string, signingTime SigningTime) []byte {
...
func (s *derivedKeyCache) get(key string, credentials hmaccred.VaultSigner, signingTime time.Time) ([]byte, bool) {
...
func deriveKey(cred hmaccred.VaultSigner, service, region string, t SigningTime) []byte {
