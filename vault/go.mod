module github.com/salrashid123/aws_hmac/vault
...
require (
	...
	github.com/salrashid123/aws_hmac/vault/signer v0.0.0-20230907025004-21e21d0dabc4 // indirect
...
replace (
	...
	// github.com/salrashid123/aws_hmac/vault/signer => ./signer
	// github.com/salrashid123/aws_hmac/vault/signer/v4 => ./signer/v4
)
