...
import (
	...
	v4Internal "github.com/salrashid123/aws_hmac/vault/internal"
)
...
type HTTPSigner interface {
	...
	SignHTTP(ctx context.Context, credentials hmaccred.HMACCredential, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*SignerOptions)) error
}
...
func (s Signer) SignHTTP(ctx context.Context, credentials hmaccred.HMACCredential, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(options *SignerOptions)) error {
	options := s.options
...
func (s *Signer) PresignHTTP(
	ctx context.Context, credentials hmaccred.HMACCredential, r *http.Request,
