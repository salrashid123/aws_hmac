...
func (s *derivedKeyCache) Get(credentials hmaccred.HMACCredential, service, region string, signingTime SigningTime) []byte {
...
func (s *derivedKeyCache) get(key string, credentials hmaccred.HMACCredential, signingTime time.Time) ([]byte, bool) {
...
func deriveKey(cred hmaccred.HMACCredential, service, region string, t SigningTime) []byte {
