...
func (s *derivedKeyCache) Get(credentials hmaccred.TinkSigner, service, region string, signingTime SigningTime) []byte {
...
func (k *SigningKeyDeriver) DeriveKey(credential hmaccred.TinkSigner, service, region string, signingTime SigningTime) []byte {
	return k.cache.Get(credential, service, region, signingTime)
}

func deriveKey(cred hmaccred.TinkSigner, service, region string, t SigningTime) []byte {
