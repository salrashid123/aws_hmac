...
type HTTPSigner interface {
	...
	SignHTTP(ctx context.Context, credentials hmaccred.TinkSigner, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*SignerOptions)) error
}
...
type httpSigner struct {
	...
	Region       string
	Time         SigningTime
	Credentials  hmaccred.TinkSigner
	KeyDerivator keyDerivator
	IsPreSign    bool
...
func (s Signer) SignHTTP(ctx context.Context, credentials hmaccred.TinkSigner, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(options *SignerOptions)) error {
	options := s.options
...
func (s *Signer) PresignHTTP(
	ctx context.Context, credentials hmaccred.TinkSigner, r *http.Request,
